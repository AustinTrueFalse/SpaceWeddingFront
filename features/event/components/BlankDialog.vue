<template>
  ...
  >
    <InputTextArea
      v-model="tempValue"
      :rows="30"
      placeholder="Здесь вы можете написать занимательные факты"
    />
...
import InputTextArea from "@/shared/components/InputTextArea.vue";
...
const titleName = computed(() => {
  return blankType.value === "groomBlank" ? "Анкета жениха" : "Анкета невесты";
});
