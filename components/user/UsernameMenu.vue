      ...
      <v-card-text>
        ...
        <div class="d-flex align-center mt-3">
          ...
          <ButtonIcon
            ...
            class="ml-1 mb-5"
            mdi-icon="mdi-pencil"
            :click-function="() => (isUserNameEdit = true)"
          />
          <ButtonIcon
            v-else
            class="ml-1 mb-5"
            ...
            :loading-status="authStore.loadingStatuses.updateUserName"
            :click-function="updateUserName"
          />
        </div>
      </v-card-text>
    </v-card>
...
import InputText from "../template/InputText.vue";
